$(document).ready(function(){
	...
	var apiKey     = 'fc0ce882bd9021c187b055b8ea0fbded';
	...
	*/
	...
	function parseWeather(data) {
		...
		$('#temp').text("Current Weather: " + data.currently.apparentTemperature);
	...
	function showError(){
		$('#temp').text('Your forecast is currently unavailable.');
